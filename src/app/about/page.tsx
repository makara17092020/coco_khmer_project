            ...
            <div className="overflow-x-auto hide-scrollbar">
              <div className="flex gap-6 px-6 md:px-6">
                {events.map((event, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 bg-white rounded-xl shadow-lg w-[210px] p-4"
                  >
                    ...
                    <h3 className="text-sm font-bold text-orange-600 mb-2 text-center">
                      {event.title}
                    </h3>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 px-4">
            <div className="bg-yellow-400 rounded-lg shadow-md p-4 text-center text-white flex flex-col justify-center items-center min-h-[280px] w-[280px]">
              <div className="mb-3 flex justify-center">
                <Image src="/images/logo.png" alt="Icon" width={28} height={28} />
              </div>
            ...
            <div className="bg-red-500 rounded-lg shadow-md p-4 text-center text-white flex flex-col justify-center items-center min-h-[280px] w-[280px]">
              ...
              <p className="text-sm leading-relaxed">
                Mission: We create clean, effective coconut-based products that empower communities and promote ethical, sustainable beauty.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="w-full flex flex-col items-center py-16 bg-white">
      ...
      <p className="text-gray-700 text-lg mb-8 text-center max-w-2xl">
        Meet the dedicated hands behind every Naga Balm product - a community of
        skilled artisans and passionate professionals.
      </p>
      ...
      <div className="grid grid-cols-2  md:grid-cols-3 gap-4x w-full max-w-5xl px-4">
        {tabs[activeTab].members.map((member: TeamMember, idx: number) => (
          <div key={idx} className="flex flex-col items-center">
            <div className="rounded-xl overflow-hidden mb-4 h-[225px] w-[190px] shadow-md relative">
              <Image
                src={member.img}
                alt={member.name}
                width={200}
            ...
            <div className="text-[#F9461C] font-bold text-base text-center">
              {member.name}
            </div>
